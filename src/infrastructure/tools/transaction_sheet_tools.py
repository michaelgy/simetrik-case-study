...
class AddTransactionInput(BaseModel):
    date: str = Field("", description="Transaction date (DD-MM-YYYY HH:MM:SS).")
...
class UpdateTransactionInput(BaseModel):
    ...
    date: str = Field("", description="New transaction date (DD-MM-YYYY HH:MM:SS).")
...
class TransactionSheetTools:
    ...
    def _initialize_tools(self):
        ...
        def find_transaction_by_number(movement_number: str) -> str:
            ...
            self.transaction_service.transactions.reload_data()
            result = self.transaction_service.transactions.find_transaction(movement_number)
            return result.to_string() if result is not None else f"Transaction {movement_number} not found."
